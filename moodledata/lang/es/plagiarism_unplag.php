...
/**
 * Strings for component 'plagiarism_unplag', language 'es', branch 'MOODLE_32_STABLE'
 *
...
$string['check_confirm'] = '¿Está seguro que quiere empezar a comprobar plagio con plugin Unplag?';
$string['check_file'] = 'Iniciar escaneo';
$string['check_start'] = 'Calculando grado de originalidad Unplag en proceso';
...
$string['useunplag_assign_desc_value'] = 'Ponga en "SI" la opción de Requiere qué estudiante haga clic en Entregar, en la sección de ajustes de tarea';
