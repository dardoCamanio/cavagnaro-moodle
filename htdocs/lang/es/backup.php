...
/**
 * Strings for component 'backup', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   backup
...
$string['configgeneraluserscompletion'] = 'Si se activa, la información a completar de los usuarios se incluirá por defecto en las copias de seguridad.';
...
$string['errorinvalidformat'] = 'Formato de backup no válido';
$string['errorinvalidformatdesc'] = 'El archivo de copia de seguridad subido no es un archivo válido de Moodle y no pudo ser restaurado.';
...
$string['errormoodle1format'] = 'Restaurando copias de seguridad de Moodle 1.9';
$string['errormoodle1formatdesc'] = 'El archivo de copia de seguridad fue creado con Moodle 1.x y no puede ser restaurado en Moodle 2. Esta funcionalidad está prevista en una futura actualización.';
$string['errormoodle1format_help'] = 'Por el momento Moodle 2 no es compatible con la restauración de copias de seguridad de Moodle 1.x.
Una posible solución sería restaurar desde Moodle 1.x hasta un Moodle 1.9.x y después actualizar a la 2.0.
Una vez finalizada la actualización podría realizar copias de seguridad que serían restauradas en otras plataformas con la versión 2.0 de Moodle.';
...
$string['generaluserscompletion'] = 'Incluir información complementaria de usuario';
...
$string['rootsettinguserscompletion'] = 'Incluir detalles complementarios de usuario';
