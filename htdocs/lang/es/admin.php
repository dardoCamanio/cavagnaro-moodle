...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   admin
...
$string['curltimeoutkbitrate'] = 'Tiempo de espera cURL (Kbps) mínimo';
$string['curltimeoutkbitrate_help'] = 'Este parámetro se usa para calcular un el tiempo de espera apropiado para peticiones cURL largas. Como parte de este cálculo se realiza una petición HTTP HEAD para determinar el tamaño del contenido.
Establecer el parámetro a 0 deshabilita esta solicitud HEAD.';
...
$string['enrolinstancedefaults'] = 'Valores predeterminados de matriculación';
...
$string['forceloginforprofileimage'] = 'Forzar a los usuarios a identificarse para ver imágenes de usuarios';
$string['forceloginforprofileimage_help'] = 'Si se habilita, los usuarios deberán identificarse para poder ver imágenes de perfiles de usuarios y se empleará la imágen por defecto en todos los correos de notificaciones.';
...
$string['langcache_desc'] = 'Caché del menú de idiomas. Si está habilitado, la lista de traducciones disponibles se almacena en la caché. La memoria caché se actualiza automáticamente al instalar o eliminar un paquete de idioma a través de la herramienta de gestión de paquetes de idioma incorporada. Si instala un nuevo paquete de idioma de forma manual, debería usar la opción "Purgar todos los caches" para actualizar la lista de caché.';
...
$string['loginpasswordautocomplete'] = 'Impedir que se auto-complete la contraseña en el formato de entrada.';
...
$string['maturitycorewarning'] = 'Usted se va a instalar o actualizar a una versión de Moodle marcados como "{$a}" que no se considera preparada aún para producción. Asegúrese de que lo hace intencionadamene y que está utilizando una versión correcta del código fuente de Moodle.';
...
$string['numcoursesincombo'] = 'Número máximo de cursos en la lista desplegable';
$string['numcoursesincombo_help'] = 'La lista desplegable no funciona bien con un gran número de cursos. Cuando el número total de cursos en el sitio es superior a este valor se mostrara un enlace al listado de cursos en lugar de tratar de mostrar todos los cursos en la primera página.';
...
$string['simpletest'] = 'Pruebas unitarias';
