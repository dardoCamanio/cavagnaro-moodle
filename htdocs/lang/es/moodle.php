...
/**
 * Strings for component 'moodle', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['commentsnotenabled'] = 'Los comentarios no están habilitados';
...
$string['coursecompletion'] = 'Finalizacvión del curso';
...
$string['courselegacyfiles_help'] = '<p>El área de archivos del curso proporciona cierta compatibilidad con las versiones de Moodle 1.9 y anteriores. Todos los archivos de esta área  son siempre accesible a todos los participantes en el curso (si los enlaza a ellos, o no) y no hay manera de saber si alguno se utiliza en algún lugar dentro de Moodle.</p> <p>Si utiliza esta área  para almacenar archivos de curso, se expone a una serie de rieesgos de privacidad y deseguridad, así como a la pérdida de archvos en las copias de seguridad, en las importaciones del curso o cada vez que el contenido del curso sea compartido o reutilizado. Por ello se recomienda que no utilice esta área a menos que realmente sepa lo que está haciendo.</p>
<p>El siguiente enlace proporciona más información acerca de todo esto y le mostraré maneras mejores de gestionar archivos en Moodle 2.';
...
$string['deletecoursecheck'] = '¿Está totalmente seguro que quier borrar definitivamente este curso y toda la información que contiene?';
...
$string['emaildisplayhidden'] = 'Dirección de correo oculta';
...
$string['legacythemesaved'] = 'Salvado nuevo tema heredado';
...
$string['startdate_help'] = '<P>Aquí es donde se especifica la fecha de inicio del curso (en su propia zona horaria).</P>
...
$string['useforlegacytheme'] = 'Uso para navegadores antiguos';
$string['useformaintheme'] = 'Uso para navegadores modernos';
