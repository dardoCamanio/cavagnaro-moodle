...
/**
 * Strings for component 'qtype_calculated', language 'es', branch 'MOODLE_20_STABLE'
 *
...
$string['dataitemdefined'] = 'está disponible con {$a} valores numéricos ya definidos';
...
$string['forceregenerationshared'] = 'forzar la regeneración solo de los comodines no compartidos';
$string['getnextnow'] = 'Obtener nuevo "Elemento a añadir" ahora';
...
$string['itemscount'] = 'Elementos<br>Número';
...
$string['partiallycorrectfeedback'] = 'Para toda respuesta parcialmente correcta';
...
$string['useadvance'] = 'Utilize el botón avanzado para ver los errores';
