...
/**
 * Strings for component 'grades', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   grades
...
<p>Cuando la estrategia de agregación de "suma de las calificaciones" se utiliza, un ítem de calificación puede actuar como crédito Extra para la categoría. Esto significa que la calificación máxima del ítem no será agregada a la calificación máxima total de la categoría, pero la calificación del item si lo será. Lo que sigue es un ejemplo:</p>
...
$string['user'] = 'Usuario';
$string['userenrolmentsuspended'] = 'Matrícula de usuario suspendida';
