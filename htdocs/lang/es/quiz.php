...
$string['layoutshuffledandpaged'] = 'Las preguntas se colocan aleatoriamente en la página con {$a} preguntas por página.';
$string['layoutshuffledsinglepage'] = 'Preguntas colocadas al azar, una por página.';
...
$string['overrideusereventname'] = '{$a->quiz} - Pasar por alto';
...
$string['quiz:manageoverrides'] = 'Gestionar anulaciones del cuestionario';
